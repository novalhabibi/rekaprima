              ...
              <div class="pin-wrapper">
                ...
                <div class="divider divider-primary divider-small mb-xl">
                  ...
                  <ul class="nav nav-list mb-xl show-bg-active">
                    <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('overview/detailtelecommunication') ?>">Len Telecommunication Systems</a></li>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-lg-12 col-md-12" style="height: 200px;">
                ...
                <a href="<?php echo base_url('overview/detailtelecommunication') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
              </div>
