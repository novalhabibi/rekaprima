                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    <header>Tambah Data Admin</header>
                                    <div class="tools">
                                ...
                                echo form_open_multipart('dashboard/admin/tambah', $attributes);
                                 ?>
                                        
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="nama_admin"
                                                        name="nama_admin" data-rule-minlength="2" maxlength="30"
                                                        required>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="username_admin"
                                                        name="username_admin" data-rule-minlength="2" maxlength="12"
                                                        required>
