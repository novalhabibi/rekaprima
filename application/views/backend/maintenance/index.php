                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    <header>Data kategorimaintenances</header>
                                    <div class="tools">
                                        <a href="<?= site_url("dashboard/kategorimaintenance/tambah") ?>" class="btn btn-icon-toggle"><i class="md md-add"></i></a>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="table-responsive">
                                            <table id="datatable1" class="table table-responsive table-hover">
                                                <thead>
                                                    <tr>
                                                        <th>Judul kategorimaintenances</th>
                                                        <th>Deskripsi</th>
                                                ...
                                                <tbody>
                                                    <?php
                                    foreach ($kategorimaintenances->result() as $kategorimaintenance) {
                                    ...
                                    ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url() ?><?= $kategorimaintenance->gambar_kategori_maintenance ?>"
                                                                data-lightbox="<?php echo base_url() ?><?= $kategorimaintenance->gambar_kategori_maintenance ?>"
                                                                data-title="<?= $kategorimaintenance->nama_kategori_maintenance ?>">
                                                                Lihat Foto
                                                            </a>
                                                        ...
                                                        <td>
                                                            ...
                                                            <a href="<?php echo base_url() ?><?= $kategorimaintenance->image_kategori_maintenance_en ?>"
                                                                data-lightbox="<?php echo base_url() ?><?= $kategorimaintenance->image_kategori_maintenance_en ?>"
                                                                data-title="<?= $kategorimaintenance->name_kategori_maintenance_en ?>">
                                                                See the Foto
                                                            </a>

                                                        </td>
                                                        <td>
                                                            <a href="#" data-target="#edit" onclick="editConfirm('<?= site_url('dashboard/kategorimaintenance/edit/'.$kategorimaintenance->id_kategori_maintenance) ?>')"
                                                                data-toggle="modal"
                                                            ...
                                                            <a data-id="<?= $kategorimaintenance->id_kategori_maintenance ?>" data-target="#hapuskategorimaintenances"
...
<!-- Hapus Via FORM -->
<div class="modal fade" id="hapuskategorimaintenances" tabindex="-1" role="dialog" aria-labelledby="hapus" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('dashboard/kategorimaintenance/hapus') ?>

            <div class="modal-body">
                <h5 class="text-center">Apakah anda yakin akan mengahpus data ini ?</h5>
                <input type="hidden" name="id_kategori_maintenance" id="bookId" value="" />
