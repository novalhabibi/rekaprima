                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    ...
                                    <div class="tools">
                                        <a href="<?= site_url("dashboard/news/tambah") ?>" class="btn btn-icon-toggle"><i class="md md-add"></i></a>
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                                    <tr class="gradeX">
                                                        ...
                                                        <td>
                                                            <a href="#" data-target="#edit" onclick="editConfirm('<?= site_url('dashboard/news/edit/'.$news->id_news) ?>')"
                                                                data-toggle="modal"
                                                            ...
                                                            <a data-id="<?= $news->id_news ?>" data-target="#hapusnews"
...
<!-- Hapus Via FORM -->
<div class="modal fade" id="hapusnews" tabindex="-1" role="dialog" aria-labelledby="hapus" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('dashboard/news/hapus') ?>

            <div class="modal-body">
                <h5 class="text-center">Apakah anda yakin akan mengahpus data ini ?</h5>
                <input type="hidden" name="id_news" id="bookId" value="" />
