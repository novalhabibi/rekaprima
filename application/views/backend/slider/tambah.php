                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    <header>Tambah Data Slide</header>
                                    <div class="tools">
                                        <a href="<?= site_url("dashboard/slider") ?>" class="btn btn-icon-toggle"><i
                                ...
                                echo form_open_multipart('dashboard/slider/tambah', $attributes);
                                 ?>
                                        
                                            <div class="card-body">
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="judul"
                                                        name="judul" data-rule-minlength="2" maxlength="30"
                                                        required>
                                                ...
                                                <div class="form-group">
                                                    <input type="text" class="form-control" id="title"
                                                        name="title" data-rule-minlength="2" maxlength="30"
                                                        required>
                                                ...
                                                <div class="form-group">
                                                    <textarea name="deskripsi" id="deskripsi" required class="form-control" cols="10" rows="5"></textarea>
                                                    <label for="deskripsi">Deskripsi</label>

                                                </div>
                                                <div class="form-group">
                                                    <textarea name="description" id="description" required class="form-control" cols="10" rows="5"></textarea>
                                            ...
                                            <div class="card-actionbar">
                                                <div class="card-actionbar-row">
                                                    ...
                                                    <button class="btn ink-reaction btn-raised btn-success"
                                                        type="submit">
