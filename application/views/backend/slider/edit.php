                ...
                <div class="section-body ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    <header>Edit Data Slider</header>
                                    <div class="tools">
                                        <a href="<?= site_url("dashboard/sldier") ?>" class="btn btn-icon-toggle"><i
                                ...
                                echo form_open_multipart('dashboard/slider/update', $attributes);
                                 ?>
                                        <!-- <div class="card"> -->
                                        <div class="card-body">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" id="judul" name="judul"
                                                    value="<?= $slider->judul ?>" data-rule-minlength="2" maxlength="30"
                                                    required>
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control" id="title" name="title"
                                                    value="<?= $slider->title ?>" data-rule-minlength="2" maxlength="30"
                                                    required>
                                                <label for="title">Usernmae</label>
                                                <p class="help-block">Minimum length 2 / Maximum length 30</p>
                                            </div>

                                            <div class="form-group">
                                                <textarea name="deskripsi" id="deskripsi" required class="form-control"
                                            ...
                                            <div class="form-group">
                                                <input type="file" class="form-control" id="foto_slider"
                                                    name="foto_slider">

                                                <input type="hidden" class="form-control"
                                                    value="<?= $slider->foto_slider ?>" name="foto_lama_slider">
                                                <label for="foto_slider">Foto slider</label>

                                                <img src="<?= base_url() ?><?= $slider->foto_slider ?>" width="200px"
