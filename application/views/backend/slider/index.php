                ...
                <div class="section-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-head">
                                    <header>Data Sliders</header>
                                    <div class="tools">
                                        <a href="<?= site_url("dashboard/slider/tambah") ?>" class="btn btn-icon-toggle"><i class="md md-add"></i></a>
                                ...
                                <div class="card-body">
                                    ...
                                    ?>
                                                    <tr class="gradeX">
                                                        <td><?= $slider->judul ?></td>
                                                        <td><?= $slider->title ?></td>
                                                        <td><?= $slider->status == 1 ?'Aktiv':'Tidak aktiv' ?></td>
                                                        <td>



                                                            <a href="<?= base_url() ?><?= $slider->gambar ?>"
                                                                data-lightbox="<?= $slider->gambar ?>"
                                                                data-title="<?= $slider->judul ?>">
                                                                Lihat Foto
                                                            </a>

                                                        </td>
                                                        <td>
                                                            <a href="#" data-target="#edit" onclick="editConfirm('<?= site_url('dashboard/slider/edit/'.$slider->id_slider) ?>')"
                                                                data-toggle="modal"
                                                            ...
                                                            <a data-id="<?= $slider->id_slider ?>" data-target="#hapusslider"
...
<!-- Hapus Via FORM -->
<div class="modal fade" id="hapusslider" tabindex="-1" role="dialog" aria-labelledby="hapus" aria-hidden="true">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <?php echo form_open('dashboard/slider/hapus') ?>

            <div class="modal-body">
                <h5 class="text-center">Apakah anda yakin akan mengahpus data ini ?</h5>
                <input type="hidden" name="id_slider" id="bookId" value="" />
