          ...
          <div class="blog-posts">
            <article class="post post-medium">
              <div class="row">
                <div class="col-md-12">
                  <div class="post-content">
                    <h4><i class="fa fa-newspaper-o"></i> <a href="<?php echo base_url('jobs/rekrutmen') ?>">Rekrutmen PT. Len Rekaprima Semesta</a></h4>
                    <p></p>
                  </div>
                </div>
              </div>
              <div class="row">
                <div class="col-md-12">
                  <div class="post-meta">
                    <span><i class="fa fa-calendar"></i> 2019-06-20 - 2019-06-28 </span>
                    <a href="<?php echo base_url('jobs/rekrutmen') ?>" class="btn btn-xs btn-primary pull-right">Read more...</a>
                  </div>
                </div>
              </div>
            </article>
            <ul class="pagination pagination-lg pull-right">
              ...
              <li class="active"><a href="/id/news-room/news-release?page=1">1</a></li>
              <li><a href="/id/news-room/news-release?page=2">&raquo;</a></li>
              <li><a href="/id/news-room/news-release?page=112">Last</a></li>
            </ul>
        ...
        <div class="col-md-3">
          <aside class="siderbar">
            ...
            <ul class="nav nav-list mb-xlg">
              <li><a href="/id/archive?years=2019">2019</a></li>
            </ul>
            <hr />                            
            <div class="contact-media">
              <h4>CONTACT</h4>
              <p>Address: <br />Jl. Soekarno-Hatta No 293 Bandung 40235</p>
              <p>Phone: <br />085720575825 <br />087824911882</p>
              <p>Email:<br />recruitment@lenrekaprima.co.id</p>
            </div>
          </aside>
        </div>
      </div>
