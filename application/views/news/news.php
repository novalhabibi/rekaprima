                    ...
                    <div class="dropdown-mega-content container">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            <li><a href="#" target="_self"><i class="fa fa-chevron-right" aria-hidden="true"></i> Berita</a></li>
                          </ul>  
                        </div>
                      </div>
                    </div>
          ...
          <div class="blog-posts">
              ...
              <div class="row">
                ...
                <div class="col-md-7">
                  <div class="post-content">
                    <h4><a href="<?php echo base_url('news/sinergi_industri_dan_pendidikan') ?>">Sinergi Industri dan Pendidikan</a></h4>
                    <div class="post-meta">
            ...
            <article class="post post-medium">
              <div class="row">
                ...
                <div class="col-md-7">
                  <div class="post-content">
                    <h4><a href="<?php echo base_url('news/news_2019_indonesia_railway_conference') ?>">Indonesia Railway Conference 2019</a></h4>
                    <div class="post-meta">
                      <span class="label label-secondary">News</span>
