...
<body>
  ...
  <div class="main" role="main">
    <section class="page-header page-header-custom-background" style="background-image:url(&#39;/Media/Image/pages/page-header-default.jpg&#39;);;height:250px;">
    </section>
    <div class="container">
      <h2>Gallery</h2>
      <hr />
        ...
        <div class="masonry-loader masonry-loader-showing">
          <div class="masonry" data-plugin-masonry>
            <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=ENERGI UNTUK SULTENG">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_cover-energi-untuk-sulteng.jpg" class="img-responsive" alt="ENERGI UNTUK SULTENG">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">ENERGI UNTUK SULTENG</h4>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/video?cat=ENERGIA TV">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Energia_TV.jpg" class="img-responsive" alt="ENERGIA TV">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">ENERGIA TV</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/video?cat=Jelajah Energi">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Jelajah_Energi.jpg" class="img-responsive" alt="Jelajah Energi">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Jelajah Energi</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=Rio Haryanto">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Rio_F1.jpg" class="img-responsive" alt="Rio Haryanto">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Rio Haryanto</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=Infografis">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Infografis.jpg" class="img-responsive" alt="Infografis">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Infografis</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=Hulu">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Hulu.jpg" class="img-responsive" alt="Hulu">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Hulu</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=Hilir">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Hilir.jpg" class="img-responsive" alt="Hilir">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Hilir</h4>
                                        <span class="thumb-info-caption-text"></span>
                    ...
                    <div class="masonry-item" style="margin:10px;width:30%;">
                        <a style="text-decoration:none;color:#000000;" href="/id/gallery/image?cat=Pertamina Energy Tower">
                            <span class="thumb-info thumb-info-hide-wrapper-bg">
                                <span class="thumb-info-wrapper">
                                    <img src="/Media/Image/gallery/cover_Pertamina_Tower.jpg" class="img-responsive" alt="Pertamina Energy Tower">
                                </span>
                                <span class="thumb-info-caption">
                                        <h4 style="padding:15px 0 0 10px;">Pertamina Energy Tower</h4>
                                        <span class="thumb-info-caption-text"></span>
