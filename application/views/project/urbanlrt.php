                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> LRT Palembang</a></li>
                        ...
                        <aside class="siderbar">
                          <div class="pin-wrapper">
                            ...
                            <ul class="nav nav-list mb-xl show-bg-active">
                              ...
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/urbanmrt') ?>">MRT Jakarta</a></li>
                            </ul>
                          </div>
                        </aside>
                      </div>
