                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="<?php echo base_url('project/urbanlrt') ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> LRT Palembang</a></li>
                        ...
                        <aside class="siderbar">
                          <div class="pin-wrapper">
                            ...
                            <ul class="nav nav-list mb-xl show-bg-active">
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtbaturaja') ?>">Double Track Baturaja - Martapura</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtcirebon') ?>">Double Track Cirebon - Surabaya</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtkedungbanteng') ?>">Double Track Kedung Banteng - Madiun</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtkertapati') ?>">Double Track Kertapati - Prabumulih</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="#">Double Track Kroya - Kutoarjo</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtmadiun') ?>">Double Track Madiun - Jombang</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtpurwokerto') ?>">Double Track Purwokerto - Kroya</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtsolo') ?>">Double Track Solo - Kedung Banteng</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtsolojogja') ?>">Double Track Solo - Jogja</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlineddtmanggarai') ?>">Double Double Track Manggarai - Cikarang</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinepsbandartinggi') ?>">Persinyalan Elektrik Bandar Tinggi - Kuala Tanjung</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinepsbinjai') ?>">Persinyalan Elektrik Binjai - Besitang</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinepsmedan') ?>">Persinyalan Elektrik Medan - Kualanamu</a></li>
                            </ul>
                          </div>
                        </aside>
                      </div>
