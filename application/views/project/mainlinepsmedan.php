...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Persinyalan Elektrik Medan - Kualanamu | PT Len Rekaprima Semesta</title>
                      ...
                      <div class="row">
                        ...
                        <span class="dropdown-mega-sub-title"><h4>Mainline</h4></span>
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> Persinyalan Elektrik Medan - Kualanamu</a></li>
                          </ul>
                        </div>
                        <div class="col-md-3">
                        ...
                        <aside class="siderbar">
                          <div class="pin-wrapper">
                            ...
                            <ul class="nav nav-list mb-xl show-bg-active">
                              ...
                              <li><a data-hash="" data-hash-offset="110" href="#">Persinyalan Elektrik Medan - Kualanamu</a></li>
                            </ul>
                          </div>
                        </aside>
                      </div>
                      <div class="col-md-9">                            
                        <h3><strong>PERSINYALAN ELEKTRIK MEDAN - KUALANAMU</strong></h3>
                        <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi saat ini masih berlangsung untuk Batangkuis – Bandar Khalipah. Selanjutnya, persiapan perawatan Double Track Medan – Kualanamu lainnya, adalah staisun Medan yang direncanakan Mei 2019.</P>
                        <p></p>
                      </div>
                    </div>
                  </div>
