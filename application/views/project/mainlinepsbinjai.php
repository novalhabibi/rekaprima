...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Persinyalan Elektrik Binjai – Besitang | PT Len Rekaprima Semesta</title>
                      ...
                      <div class="row">
                        ...
                        <span class="dropdown-mega-sub-title"><h4>Mainline</h4></span>
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> Persinyalan Elektrik Binjai - Besitang</a></li>
          ...
          <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/psbinjai2.jpg') ?>);height:250px;"></section>
                  <div class="container">
                    <div class="row">
                        ...
                        <aside class="siderbar">
                          <div class="pin-wrapper">
                            ...
                            <ul class="nav nav-list mb-xl show-bg-active">
                              ...
                              <li><a data-hash="" data-hash-offset="110" href="#">Persinyalan Elektrik Binjai - Besitang</a></li>
                      ...
                      <div class="col-md-9">                            
                        <h3><strong>PERSINYALAN ELEKTRIK BINJAI - BESITANG</strong></h3>
                        <p style="text-align: justify;">Pekerjaan perawatan fasiitas operasi di Persinyalan Elektrik Binjai – Besitang salah satu pekerjaan perawatan PT. Len Rekaprima Semesta mendatang. Direncanakan pada tahun 2019 untuk memulai pekerjaan perawatan. Beberapa stasiun yang akan dilakukan pekerjaan perawatan sebagai berikut :</P>
                        <ol style="list-style-type: lower-number;">
                          <li style="text-align: justify;">Stasiun Binjai</li>
                          <li style="text-align: justify;">Stasiun Kuala Bingai</li>
                          <li style="text-align: justify;">Stasiun Stabat</li>
                          <li style="text-align: justify;">Stasiun Tanjung Slamat</li>
                          <li style="text-align: justify;">Stasiun Tanjung Pura</li>
                          <li style="text-align: justify;">Stasiun Gebang</li>
                          <li style="text-align: justify;">Stasiun Pangkalan Brandan</li>
                          <li style="text-align: justify;">Stasiun Besitang</li>
                        </ol>
                        <p></p>
                      </div>
                    </div>
