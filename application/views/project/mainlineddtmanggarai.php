    ...
    <div class="container">
      <div class="row">
          ...
          <aside class="siderbar">
            <div class="pin-wrapper">
              ...
              <ul class="nav nav-list mb-xl show-bg-active">
                ...
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('project/mainlinedtkroya') ?>">Double Track Kroya - Kutoarjo</a></li>
        ...
        <div class="col-md-9">                            
          ...
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Doble Track Manggarai - Cikarang dilakukan parsial sesuai serah terima proyek instalasi. Pekerjaan perawatan fasilitas operasi yang pertama dilakukan per tahun 2018 adalah sebagai berikut :</P>
          <ol style="list-style-type: lower-number;">
            <li style="text-align: justify;">Stasiun Cikarang</li>
            <li style="text-align: justify;">Stasiun Tambun</li>
            <li style="text-align: justify;">Stasiun Bekasi</li>
            <li style="text-align: justify;">Stasiun Cakung</li>
            <li style="text-align: justify;">Stasiun Manggarai</li>
          </ol>
          <p style="text-align: justify;">Stasiun berikutnya yang akan diproyeksikan pekerjaan fasiitas operasi di Double Double Track Manggarai- Cikarang pada bulan Mei 2019 adalah Depo Cipinang dan stasiun Jatinegara.</P>
          <p></p>
