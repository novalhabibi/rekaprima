...
<head>
    ...
    <title>Home | PT Len Rekaprima Semesta E</title>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('overview/aboutus') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Siapa Kami</a></li>
                                                            <li><a href="<?php echo base_url('overview/sejarah') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Sejarah Len Rekaprima
                                                                    Semesta</a></li>
                                                            <li><a href="<?php echo base_url('overview/visimisi') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Visi &amp; Misi</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('overview/strukturorganisasi') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Struktur Organisasi</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('overview/management') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Management</a></li>
                                                            <li><a href="<?php echo base_url('overview/komisaris') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Dewan Komisaris</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                            ...
                                            <div class="dropdown-mega-content container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('overview/signaling') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Signalling Systems</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url('overview/substation') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Substations Systems</a>
                                                            </li>
                                                            <li><a
                                                                    href="<?php echo base_url('overview/telecommunication') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Telecommunication
                                                                    Systems</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-mega-content container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtbaturaja') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Baturaja -
                                                                    Martapura</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtcirebon') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Cirebon -
                                                                    Surabaya</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtkedungbanteng') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kedung
                                                                    Banteng - Madiun</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtkertapati') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kertapati -
                                                                    Prabumulih</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtkroya') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kroya -
                                                                    Kutoarjo</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtmadiun') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Madiun -
                                                                    Jombang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtpurwokerto') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Purwokerto
                                                                    - Kroya</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtsolo') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinedtsolojogja') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Solo -
                                                                    Jogja</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlineddtmanggarai') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Double Track
                                                                    Manggarai - Cikarang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinepsbandartinggi') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Persinyalan Elektrik
                                                                    Bandar Tinggi - Kuala Tanjung</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinepsbinjai') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Persinyalan Elektrik
                                                                    Binjai - Besitang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('project/mainlinepsmedan') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Persinyalan Elektrik
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('project/urbanapms') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> APMS Skytrain</a></li>
                                                            <li><a href="<?php echo base_url('project/urbanlrt') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> LRT Sematera Selatan</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url('project/urbanmrt') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            ...
                                                            <li><a href="<?php echo base_url('jobs/rekrutmen') ?>"
                                                                    target="_self"><i class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Tenaga Berpengalaman</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="#" target="_self"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Galeri</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <span class="dropdown-mega-sub-title">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('news/news') ?>"
                                                                    target="_self"><i class="fa fa-chevron-right"
        ...
        <div class="container">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 center">
                        <div class="heading heading-border heading-middle-border heading-middle-border-center">
                            <h2>BISNIS <strong>KAMI</strong></h2>
                        </div>
                    </div>
                </div>
                <div class="row mt-md mb-xl">
                                ...
                                <div class="owl-carousel owl-theme"
                                    ...
                                    <div class="box-item">
                                        <div class="box-post">
                                            <h1 class="post-title">
                                                <a
                                                    href="<?php echo base_url('news/sinergi_industri_dan_pendidikan') ?>">
                                    ...
                                    <li>
                                        <div class="post-image">
                                            <div class="img-thumbnail">
                                                <a
                                                    href="<?php echo base_url('news/news_2019_indonesia_railway_conference') ?>">
                                        ...
                                        <div class="post-info">
                                            <a
                                                href="<?php echo base_url('news/news_2019_indonesia_railway_conference') ?>">Indonesia
