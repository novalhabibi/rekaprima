...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Management | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                    ...
                    <div class="dropdown-mega-content container">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            <li><a href="#" target="_self"><i class="fa fa-chevron-right" aria-hidden="true"></i> Galeri</a></li>
                          </ul>  
                        </div>
                        <div class="col-md-3">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/management') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                                ...
                                <span class="thumb-info"> 
                                  <span class="thumb-info-wrapper"> 
                                    ...
                                    <span class="thumb-info-title"> 
                                      ...
                                      <span class="thumb-info-type">Direktur</span> 
                                    </span> 
                              ...
                              <div id="direktur" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                    ...
                                    <h4 class="heading-primary">Direktur</h4>
                                    Lahir tanggal 20 Agustus 1977. Berdomisili di Bandung, Indonesia. Ditunjuk pertama kali sebagai Direktur PT Len Rekaprima Semesta sejak 2018.
                                  </div>
                                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Asep Ukun Mulyana merupakan lulusan Teknik Material - ITB(S1) tahun 2001.<br>Sebelum menjabat sebagai Direktur PT Len Rekaprima Semesta, menjabat sebagai Vice President Project Operation & Procurement di PT Len Railway Systems sejak 2015 sampai 2018, sebagai Vice President Project Planning & Logistic 2013 sampai 2015, sebagai Senior Principle Designer Mechanical Design Engineering & Production sejak 2012 sampai 2013. Sebelumnya juga pernah menjadi Bagian Desain Sistem Proyek UB Sistem Transportasi di PT Len Industri (Persero) sejak 2009 sampai 2012.
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div id="vp-hc" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                    ...
                                    Lahir tanggal 28 Maret 1970. Berdomisili di Bandung, Indonesia. Memperoleh gelar sarjana ekonomi di Universitas Pasundan pada tahun 1995.
                                  </div>
                                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Sebelum menjabat sebagai VP Finance & Administration di PT Len Rekaprima Semesta sejak 2018, menjabat sebagai Staff Ahli Direktur Teknologi & Operasi Bidang Pengembangan Bisnis di PT Len Railway Systems sejak 2017 sampai 2018, menjabat sebagai Senior Manager bagian Komersial UB. Sistem Transportasi tahun 2017, menjabat sebagai Direktur Utama Dana Pensiun di PT Len Industri sejak 2016 sampai 2017, menjabat sebagai Manager Keuangan di PT Len Industri sejak 2013 sampai 2014.
                                  </div>
                                </div>
                              </div>
                            </div>
                              ...
                              <div id="vp-mt" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                    ...
                                    Lahir tanggal 4 September 1984. Berdomisili di Bandung, Indonesia. Memperoleh gelar sarjana Teknik Elektro di STT Telkom pada tahun 2006.
                                  </div>
                                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Sebelum dipercaya sebagai Executive Vice President Maintenance And Operation di PT Len Rekaprima Semesta 2018, menjabat sebagai Manager Maintenance & Aftersales Service di PT Len Railway Systems 2016 sampai 2018, sebagai Senior Testing Engineer di PT Railway Systems sejak 2012 sampai 2016. Ia juga pernah mengerjakan Jasa Konstruksi dan Instalasi System Persinyalan Elektrik (SIL) St. Kisaran, St. Tarahan, St. Tegal-Pekalongan di PT Len Industri (Persero) tahun 2011.
                                  </div>
                                </div>
                              </div>
                            </div>
                                ...
                                <span class="thumb-info"> 
                                  <span class="thumb-info-wrapper"> 
                                    ...
                                    <span class="thumb-info-title"> 
                                      ...
                                      <span class="thumb-info-type">VP Marketing & Bisnis Development</span> 
                                    </span> 
                                    <span class="thumb-info-action"> 
                                      <span class="thumb-info-action-icon"> 
                                        <i class="fa fa-link"></i> 
                              ...
                              <div id="vp-marketing" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                                <div class="row">
                                  ...
                                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                    ...
                                    <h4 class="heading-primary">VP Marketing & Bisnis Development</h4>
                                    Lahir tanggal 24 Juli 1964. Berdomisili di Bandung, Indonesia. Memperoleh gelar sarjana Teknik Telekomunikasi ITB tahun 1991.
                                  </div>
                                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Ia menjabat sebagai Vice President Marketing & Bisnis Development di PT Len Rekaprima Semesta sejak 2018.
                                  </div>
                                </div>
                              </div>
                            </div>
