...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Sejarah | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/history') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Len didirikan sejak tahun 1965 dengan nama LEN (Lembaga Elektroteknika Nasional) adalah perusahaan peralatan elektronik industri milik Pemerintah Indonesia (BUMN) yang berkantor pusat di Bandung, Jawa Barat.</p>
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Len mengembangkan Sistem persinyalan kereta api yang hingga kini telah mengembangkan Pembangkit Listrik Tenaga Surya yang hingga kini telah tersebar puluhan ribu unit di seluruh pelosok wilayah Indonesia hingga ke mancanegara.</p>
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">    
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Sebagai perusahaan yang menghasilkan elektronika transportasi khususnya perkeretaapian, Len menempatkan keamanan dan kehandalan sebagai perhatian utama dalam pengembangan produk dengan moto “failsafe – no compromise”.</p>
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Len sukses menorehkan tinta emas dalam dunia persinyalan kereta api Nasional, kami telah menjadi pelaku utama dan satu-satunya industri sinyal perkeretaapian di Indonesia. Bisnis Kereta Api ditangani oleh Unit Bisnis Transportasi.</p>
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Bisnis kereta api telah ditangani oleh PT LRS (Len Railway Systems) sebagai anak perusahaan PT.Len Industri yang berperan sebagai EPC bidang Railway Transportation dan menjadi pemimpin pasar di sektor kereta api E&M di Indonesia, termasuk produk, teknik, dan layanan.</p>
                              </div>
                            </div>
                          </div>  
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>Maintenance & Aftersales Division adalah divisi dari PT LRS (Len Railway Systems) yang tugas utamanya adalah untuk melakukan perawatan system persinyalan perkeretaapian.</p>
                              </div>
                            </div>
                          </div>
                        </li>
                          ...
                          <div class="col-md-8 animated fadeInUp">
                            <div class="featured-box" style="margin-left: 0px;margin-top: 30px;margin-bottom: 35px;">
                              <div class="box-content">
                                ...
                                <p>PT Len Rekaprima Semesta adalah sebuah transformasi dari Maintenance & Aftersales Division yang juga merupakan anak perusahaan dari PT LRS (Len Railway Systems) hingga saat ini semua perawatan dan service ditangani oleh kami.</p>
                              </div>
                            </div>
                          </div>  
                        </li>
