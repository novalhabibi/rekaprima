...
<head>
    ...
    <title>Siapa Kami | PT Len Rekaprima Semesta</title>
    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            ...
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/aboutus1.jpg') ?>);height:250px;">
                    ...
                    <div class="col-md-12">
                        <table class="table table-striped">
                            <tbody>
                                <tr>
                                    <td style="width: 100%;">
                                        <h4 style="text-align: center;"><strong>RIWAYAT SINGKAT PERUSAHAAN</strong></h4>
                                    </td>
                                </tr>
                            </tbody>
                        </table>
                        <p style="text-align: justify;">PT Len Rekaprima Semesta senantiasa bekerja keras dan
                            berkomitmen menjadi mitra bisnis terdepan dari pemilik Infrastruktur Perkeretaapian dalam
                            meningkatkan produktifitas dan mobilitas masyarakat Indonesia.</p>
                        <p style="text-align: justify;">Komitmen ini dibuktikan dengan penyediaan dan pengelolaan
                            Operasi dan Perawatan yang handal dan berkualitas guna memenuhi kebutuhan konsumen akan
                            produk yang unggul. Kini saatnya, PT Len Rekaprima Semesta memantapkan langkah, menyongsong
                            tantangan yang membentang dengan penuh optimisme guna menciptakan pertumbuhan bisnis
                            Perusahaan yang berkelanjutan melalui investasi dan optimalisasi bisnis agar terus tumbuh
                            sesuai dengan harapan seluruh pemangku kepentingan.</p>
                        <p style="text-align: justify;">Tonggak sejarah PT Len Industri masuk dalam bisnis
                            Perkeretaapian dimulai sejak tahun 1983. Sebagai perusahaan yang menghasilkan elektronika
                            transportasi khususnya perkeretaapian, Len menempatkan keamanan dan kehandalan sebagai
                            perhatian utama dalam pengembangan produk dengan moto “failsafe – no compromise”. Kami telah
                            menjadi pelaku utama dan satu-satunya industri sinyal perkeretaapian di Indonesia.</p>
                        <p style="text-align: justify;">PT Len Industri sukses menorehkan tinta emas dalam dunia
                            persinyalan kereta api Nasional, dimana SIL-02 (Sistem Interlocking Len-02) diterapkan di
                            Jalur Utara Pulau Jawa Cirebon-Surabaya sepanjang 435 Km melintasi lebih dari 55 stasiun
                            dengan sistem telekomunikasi fiber optic. Proyek prestisius lain diraih 1 tahun kemudian,
                            pada tahun 2014 yakni Double Double Track (DDT) Manggarai-Cikarang sepanjang 32 Km, yang
                            dibagi menjadi 2 tahap yaitu Manggarai-Bekasi sepanjang 15 Km dan Bekasi-Cikarang sepanjang
                            17 Km.</p>
                        <p style="text-align: justify;">PT Len Industri melakukan transformasi fundamental dengan
                            pembentukan anak perusahaan yang fokus pada bisnis transportasi Perkeretaapian pada tahun
                            2011 yang diberi nama PT Len Railway Systems. Melalui PT Len Railway Systems, pembangunan
                            infrastruktur Perkeretaapian telah dilakukan baik dalam pembangunan untuk kebutuhan mainline
                            maupun untuk kebutuhan urban transport.</p>
                        <p style="text-align: justify;">Dalam menjaga kesinambungan bisnis Perkeretaapian di Indonesia,
                            pada tahun 2014 PT Len Railway Systems membentuk divisi khusus yang bergerak dalam bidang
                            Pemeliharaan dan Perawatan Fasilitas Operasi Perkeretaapian. Divisi ini menjadi cikal bakal
                            PT Len Rekaprima Semesta yang dibentuk sebagai anak usaha PT Len Railway Systems pada tahun
                            2017. Selain bergerak dalam bidang Pemeliharaan dan Perawatan Fasilitas Operasi
                            Perkeretaapian, PT Len Rekaprima Semesta juga melakukan Pengoperasian Sarana Perkeretaapian
                            seperti halnya yang saat ini berjalan di APMS Skytrain Bandara Internasional Soekarno Hatta.
                        </p>
                    </div>
                </div>
            </div>
