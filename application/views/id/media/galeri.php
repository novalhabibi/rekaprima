    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/gallery.jpg') ?>);height:250px;">
            </section>
            <div class="container">
                <h2>Gallery</h2>
                <hr />
                        ...
                        <div class="masonry" data-plugin-masonry>
                                ...
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Perawatan_PSD_MRTJ.jpg') ?>"
                                                class="img-responsive" alt="PERAWATAN PSD MRTJ">
                                        </span>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Pelatihan_Aplikasi_Sisfo_Balai_Pengujian_DJKA.jpg') ?>"
                                                class="img-responsive" alt="ENERGI UNTUK SULTENG">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Pelatihan Aplikasi
                                                Sisfo Balai Pengujian DJKA</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                                </a>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Perawatan_Point_Machine_Martapura-Baturaja.jpg') ?>"
                                                class="img-responsive" alt="Perawatan Point Machine Martapura-Baturaja">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Perawatan Point Machine
                                                Martapura-Baturaja</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                                </a>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Kunjungan_Kerja_Lapangan_API_Madiun_Ke_APMS.jpg') ?>"
                                                class="img-responsive"
                                                alt="Kunjungan Kerja Lapangan API Madiun Ke APMS">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Kunjungan Kerja
                                                Lapangan API Madiun Ke APMS</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                                </a>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Perawatan_Axle_Counter_ST.Baturaja.jpg') ?>"
                                                class="img-responsive" alt="Perawatan Axle Counter ST.Baturaja">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Perawatan Axle Counter
                                                ST.Baturaja</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Training_In_House_Awareness_ISO_9001,_14001_dan_45001.jpg') ?>"
                                                class="img-responsive" alt="Training Awareness ISO 9001, 14001, 45001">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Training Awareness ISO
                                                9001, 14001, 45001</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Pemeriksaan_Sistem_Power_di_LRT_Palembang.jpg') ?>"
                                                class="img-responsive" alt="Pemeriksaan Sistem Power di LRT Palembang">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Pemeriksaan Sistem
                                                Power di LRT Palembang</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                                </a>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/Sharing_Session_Project_Management.jpg') ?>"
                                                class="img-responsive" alt="Sharing Session Project Management">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">Sharing Session Project
                                                Management</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
                            ...
                            <div class="masonry-item" style="margin:10px;width:30%;">
                                <a>
                                    <span class="thumb-info thumb-info-hide-wrapper-bg">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/galeri/OCC_Sky_Train_Bandara_Soekarno-Hatta.jpg') ?>"
                                                class="img-responsive" alt="OCC Sky Train Bandara Soekarno-Hatta">
                                        </span>
                                        <span class="thumb-info-caption">
                                            <h6 style="padding:10px 0 0 10px; font-weight: bold">OCC Sky Train Bandara
                                                Soekarno-Hatta</h6>
                                            <span class="thumb-info-caption-text"></span>
                                        </span>
                                    </span>
