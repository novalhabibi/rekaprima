...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Beranda | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                        ...
                        <div class="col-md-3">
                          ...
                          <div class="col-md-3">
                            <span class="dropdown-mega-sub-title"><h4>Pemimpin Kami</h4></span>
                              <ul class="dropdown-mega-sub-nav">
                                <li><a href="<?php echo base_url('id/management') ?>"><i class="fa fa-chevron-right" aria-hidden="true"></i> Manajemen</a></li>
                    ...
                    <div class="dropdown-mega-content container">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            <li><a href="<?php echo base_url('id/galeri') ?>" target="_self"><i class="fa fa-chevron-right" aria-hidden="true"></i> Galeri</a></li>
                          </ul>  
                        </div>
                        <div class="col-md-3">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/home') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <img src="<?php echo base_url('assets/media/image/slider/Rekaprima_51.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              ...
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
               <h4 style="text-align: left;"><span>Len Rekaprima Semesta selalu memastikan untuk menjaga fungsionalitas peralatan sistem kereta api secara berkala.<br /></span></h4>
              </h4>
            </div>
        </div>
        <div class="item ">
...
<div class="container">
  <div class="row">
    <div class="col-md-12 center">
      <div class="heading heading-border heading-middle-border heading-middle-border-center">
        <h2>PROFIL <strong>PERUSAHAAN</strong></h2>
      </div>
    </div>
  </div>
  <div class="row mt-md mb-xl">
    ...
    <div class="col-md-6">
      <p style="margin-bottom: 10px;" class="justify">PT. Len Rekaprima Semesta adalah perusahaan yang sedang berkembang dan merupakan anak perusahaan dari salah satu Badan Usaha Milik Negara (BUMN) PT. Len Industri (Persero), yang bergerak dibidang Operation & Maintenance Perkeretaapian. Guna menunjang kebutuhan sumber daya manusia dan dengan berkembang pesatnya dunia bisnis, PT. Len Rekaprima Semesta mengundang individu - individu yang berkualitas untuk dapat bergabung dan maju bersama perusahaan kami. Kami tidak pemah memungut biaya apapun dalam proses rekrutmen. Kami  tidak pernah bekerja sama dengan travel agent di biro perjalanan tertentu dalam proses rekrutmen.</p>
      <div class="center">
          ...
          <div class="col-md-7">
            <div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10, 'autoplay':true}">
              <div class="box-item">
                <div class="box-post">
                  <h1 class="post-title">
                    <a href="<?php echo base_url('id/news_2019_sinergi_industri_dan_pendidikan') ?>">
                ...
                <img src="<?php echo base_url('assets/media/image/event/newevent6.jpg') ?>" alt="Sinergi Industri dan Pendidikan" class="img-responsive">
              </div>
            </div>
          </div>
          <div class="col-md-5">
              ...
              <li>
                <div class="post-image">
                  <div class="img-thumbnail">
                    <a href="<?php echo base_url('news/news_2019_indonesia_railway_conference') ?>">
                ...
                <div class="post-info">
                  <a href="<?php echo base_url('news/news_2019_indonesia_railway_conference') ?>">Indonesia Railway Conference 2019</a>
                  <div class="post-meta">
...
<br />
  <div class="container">
    <div class="row">
      <div class="col-md-12 center">
      <div class="heading heading-border heading-middle-border heading-middle-border-center">
        <h2>PARTNER <strong>KAMI</strong></h2>
      </div>
      </div>
    </div>
