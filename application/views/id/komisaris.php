...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
    ...
    <title>Dewan Komisaris | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/commissioners') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <span class="thumb-info"> 
                  <span class="thumb-info-wrapper"> 
                    ...
                    <span class="thumb-info-title"> 
                      ...
                      <span class="thumb-info-type">Komisaris Utama</span> 
                    </span> 
              ...
              <div id="komisaris1" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                    ...
                    <h4 class="heading-primary">Komisaris Utama</h4>
                    Lahir tanggal 11 Maret 1968. Berdomisili di Bandung, Indonesia. Ditunjuk pertama kali sebagai Komisaris PT Len Rekaprima Semesta sejak 2018.
                  </div>
                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Agung Darmawan merupakan lulusan Teknik Elektro - ITB(S1) tahun 1992.<br>Sebelum menjabat sebagai Komisaris PT Len Rekaprima Semesta, menjabat sebagai Direktur Teknologi & Operasi di PT Len Railway Systems sejak 2017 sampai 2018, sebagai Senior General Manager UB.Information & Communication Technology di PT Len Industri (Persero) sejak 2016 sampai 2017, sebagai Senior Vice President Divisi Pusat Teknologi dan Inovasi di PT Len Industri (Persero) sejak 2015 sampai 2016. Sebelumnya juga pernah menjadi General Manager Divisi Pusat Teknologi dan Inovasi di PT Len Industri (Presero) sejak 2011 sampai 2015.
                  </div>
                </div>
              </div>
            </div>
                ...
                <span class="thumb-info"> 
                  <span class="thumb-info-wrapper"> 
                    ...
                    <span class="thumb-info-title"> 
                      ...
                      <span class="thumb-info-type">Komisaris</span> 
                    </span> 
                    <span class="thumb-info-action"> 
                      <span class="thumb-info-action-icon"> 
                        <i class="fa fa-link"></i> 
              ...
              <div id="komisaris2" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                <div class="row">
                  ...
                  <div class="col-md-8 col-sm-8" style="text-align: justify;">
                    ...
                    <h4 class="heading-primary">Komisaris</h4>
                    Lahir tanggal 5 Maret 1965. Berdomisili di Bandung, Indonesia. Ditunjuk pertama kali sebagai Komisaris PT Len Rekaprima Semesta sejak 2018.
                  </div>
                    <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Yani Kurniati merupakan lulusan Akuntansi - UNPAD(S1) tahun 1987.<br>Sebelum menjabat sebagai Komisaris PT Len Rekaprima Semesta, menjabat sebagai Direktur Finance & Human Capital di PT Len Railway Systems sejak 2016 sampai 2018, sebagai Senior Vice President MSO di PT Len Industri (Persero) 2015 sampai 2016, sebagai Senior Vice President Satuan Pengawasan Internal PT Len Industri (Persero) sejak 2013 sampai 2015. Sebelumnya juga pernah menjadi Senior General Manager Divisi Keuangan & Akuntansi di PT Len Industri (Presero) sejak 2011 sampai 2013.
                  </div>
                </div>
              </div>
            </div>
