       ...
       <?php $this->load->view('id/_includes/header.php') ?>
        ...
        <div class="main" role="main">
            ...
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/komisaris1.jpg') ?>);height:250px;">
                        ...
                        <div class="row">
                                ...
                                <a href="#komisaris1" class="popup-with-zoom-anim">
                                    <span class="thumb-info">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/management/komisaris1.jpg') ?>"
                                    ...
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <img class="img-responsive mb-lg"
                                                src="<?php echo base_url('assets/media/image/management/komisaris1.jpg') ?>">
                                        </div>
                                        <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                            ...
                                            Lahir tanggal 11 Maret 1968. Berdomisili di Bandung, Indonesia. Ditunjuk
                                            pertama kali sebagai Komisaris PT Len Rekaprima Semesta sejak 2018.
                                        </div>
                                        <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Agung Darmawan
                                            merupakan lulusan Teknik Elektro - ITB(S1) tahun 1992.<br>Sebelum menjabat
                                            sebagai Komisaris PT Len Rekaprima Semesta, menjabat sebagai Direktur
                                            Teknologi & Operasi di PT Len Railway Systems sejak 2017 sampai 2018,
                                            sebagai Senior General Manager UB.Information & Communication Technology di
                                            PT Len Industri (Persero) sejak 2016 sampai 2017, sebagai Senior Vice
                                            President Divisi Pusat Teknologi dan Inovasi di PT Len Industri (Persero)
                                            sejak 2015 sampai 2016. Sebelumnya juga pernah menjadi General Manager
                                            Divisi Pusat Teknologi dan Inovasi di PT Len Industri (Presero) sejak 2011
                                            sampai 2015.
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-4 col-sm-6">
                                <a href="#komisaris2" class="popup-with-zoom-anim">
                                    <span class="thumb-info">
                                        <span class="thumb-info-wrapper">
                                            <img src="<?php echo base_url('assets/media/image/management/komisaris2.jpg') ?>"
                                                class="img-responsive" caption="false" width="350" height="400">
                                            <span class="thumb-info-title">
                                ...
                                <div id="komisaris2" class="dialog dialog-lg zoom-anim-dialog p-xlg mfp-hide">
                                    <div class="row">
                                        <div class="col-md-4 col-sm-4">
                                            <img class="img-responsive mb-lg"
                                                src="<?php echo base_url('assets/media/image/management/komisaris2.jpg') ?>">
                                        </div>
                                        <div class="col-md-8 col-sm-8" style="text-align: justify;">
                                            <h2 class="mb-none">Yani Kurniati, SE., AK., CA</h2>
                                            <h4 class="heading-primary">Komisaris</h4>
                                            Lahir tanggal 5 Maret 1965. Berdomisili di Bandung, Indonesia. Ditunjuk
                                            pertama kali sebagai Komisaris PT Len Rekaprima Semesta sejak 2018.
                                        </div>
                                        <div class="col-md-8 col-sm-8" style="text-align: justify;"><br>Yani Kurniati
                                            merupakan lulusan Akuntansi - UNPAD(S1) tahun 1987.<br>Sebelum menjabat
                                            sebagai Komisaris PT Len Rekaprima Semesta, menjabat sebagai Direktur
                                            Finance & Human Capital di PT Len Railway Systems sejak 2016 sampai 2018,
                                            sebagai Senior Vice President MSO di PT Len Industri (Persero) 2015 sampai
                                            2016, sebagai Senior Vice President Satuan Pengawasan Internal PT Len
                                            Industri (Persero) sejak 2013 sampai 2015. Sebelumnya juga pernah menjadi
                                            Senior General Manager Divisi Keuangan & Akuntansi di PT Len Industri
                                            (Presero) sejak 2011 sampai 2013.
                                        </div>
                                    </div>
                                </div>
                            </div>
