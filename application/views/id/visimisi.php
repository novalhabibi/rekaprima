...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Visi & Misi | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/vision_mission') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    ...
                                    <p style="text-align: center;">Menjadi Perusahaan Operator & Maintenance Perkeretaapian Nasional yang handal.</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <h4 style="text-align: center;"><strong>MISI</strong></h4>
                                    <p style="text-align: center;">Membangun Rekaprima Menjadi entitas bisnis baru yang dapat menjadi mitra bisnis terdepan dari pemilik infrastruktur perkeretaapian dalam meningkatkan produktifitas dan mobilitas masyarakat Indonesia dengan pengelolaan Operasi dan perawatan berkelas Internasional dan handal.</p>
                                </div>
                            </div>
                        </div>
                    </div>
