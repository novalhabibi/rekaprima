    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            ...
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/visimisi1.jpg') ?>);height:250px;">
                    ...
                    <div class="col-md-12">
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                ...
                                <p style="text-align: center;">Menjadi Perusahaan Operator & Maintenance Perkeretaapian
                                    Nasional yang handal.</p>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12 col-lg-12">
                                <h4 style="text-align: center;"><strong>MISI</strong></h4>
                                <p style="text-align: center;">Membangun Rekaprima Menjadi entitas bisnis baru yang
                                    dapat menjadi mitra bisnis terdepan dari pemilik infrastruktur perkeretaapian dalam
                                    meningkatkan produktifitas dan mobilitas masyarakat Indonesia dengan pengelolaan
                                    Operasi dan perawatan berkelas Internasional dan handal.</p>
                            </div>
                        </div>
                    </div>
                </div>
