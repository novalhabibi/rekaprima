	...
	<header id="header" class="header-no-border-bottom" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 10, 'stickySetTop': '0px', 'stickyChangeLogo': false}">
      <div class="header-body">
            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_ctc') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
        ...
        <div class="main" role="main">
          <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/signalling2.jpg') ?>);height:250px;"></section>
                  <div class="container">
                    <div class="row">
                      <div class="col-md-3">
                      ...
                      <div class="col-md-9">                            
                        ...
                        <p style="text-align: justify;">PT Len Industri memproduksi perangkat persinyalan dimana dapat memantau langsung kondisi beserta mengoperasikan peralatan persinyalan dibeberapa stasiun didalam suatu ruangan, perangkat ini dinamakan LEN CTC (Centralized Traffic Control). Perangkat ini telah terpasang di beberapa DAOP (Daerah Operasi), diantaranya :</p>
