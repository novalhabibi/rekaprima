...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Len Led Signal | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_led_signal') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9">                            
                            ...
                            <p style="text-align: justify;">Seiring dengan berkembangnya teknologi, PT Len Industri memproduksi perangkat persinyalan yang dinamakan LEN LED SIGNAL, dimana komponen utamanya ialah LED yang dapat menghemat energi dengan kualitas pencahayaan yang baik. Jenis – jenis sinyal yang telah diproduksi ialah sebagai berikut :</p>
