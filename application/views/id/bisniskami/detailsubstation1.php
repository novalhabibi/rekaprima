            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_link_brake_device') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12" style="height: 200px;">
                      ...
                      <p style="text-align: justify;">Len Substaions Systems adalah instrumen yang menghubungkan satu gardu daya ke gardu induk lainnya untuk menghasilkan intertripping. Ini adalah fungsi protection untuk mencegah gardu listrik dibebankan secara tidak normal. Host dan gardu sebelahnya bertukar status melalui panel LBD. Mereka menggunakan serat optik sebagai antarmuka media komunikasi dan ethernet TCP / IP sebagai protokol komunikasi. Setiap kali masalah terjadi, seperti korsleting, HOst LBD akan mengirim perintah trip (status) ke gardu sebelahnya. Ketika status ini diterima, gardu sebelahnya juga akan melakukan trip.</p>
                    </div>
                  </div>
                </div>
              </div>
