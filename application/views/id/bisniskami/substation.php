                ...
                <div class="container">
                      ...
                      <aside class="siderbar">
                        <div class="pin-wrapper">
                          ...
                          <ul class="nav nav-list mb-xl show-bg-active">
                            <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('overview/detailsubstation') ?>">Len Substations Systems</a></li>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12" style="height: 200px;">
                      ...
                      <a href="<?php echo base_url('overview/detailsubstation') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                    </div>
                    <div class="col-lg-12 col-md-12">
                      <div class="row">
                        <div class="col-md-4" style="height: 500px;">
                          ...
                          <a href="<?php echo base_url('overview/detailsubstation1') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                        </div>
                        <div class="col-md-4" style="height: 500px;">
                          ...
                          <a href="<?php echo base_url('overview/detailsubstation2') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                        </div>
                      </div>
                    </div>
                  </div>
