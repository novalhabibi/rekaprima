            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/substations_systems') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <div class="container">
                      ...
                      <aside class="siderbar">
                        <div class="pin-wrapper">
                          ...
                          <ul class="nav nav-list mb-xl show-bg-active">
                            <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/len_substations_systems') ?>">Len Substations Systems</a></li>
                            <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/len_link_brake_device') ?>">Len Link Brake Device</a></li>
                            <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/len_visual_control_panel') ?>">Len Visual Control Panel</a></li>
                          </ul>
                        </div>
                      </aside>
                    </div>
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12" style="height: 200px;">
                      ...
                      <p style="text-align: justify;">Len Substaions Systems adalah bagian dari sistem pembangkit, transmisi, dan distribusi listrik. Gardu mengubah tegangan dari tinggi ke rendah, atau sebaliknya, atau melakukan salah satu dari beberapa fungsi penting lainnya.</p>
                      <a href="<?php echo base_url('id/len_substations_systems') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                    </div>
                    <div class="col-lg-12 col-md-12">
                      <div class="row">
                        <div class="col-md-4" style="height: 500px;">
                          ...
                          <p style="text-align: justify;">Len Link Brake Device (LBD) adalah instrumen yang menghubungkan satu gardu listrik dengan yang lain untuk menghasilkan inter tripping.</p>
                          <a href="<?php echo base_url('id/len_link_brake_device') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                        </div>
                        <div class="col-md-4" style="height: 500px;">
                          ...
                          <p style="text-align: justify;">Len Visual Control Panel (VCP) adalah panel yang mengontrol dan memantau gardu daya traksi secara lokal. Ini adalah layar sentuh yang dioperasikan berdasarkan HMI yang berjalan pada PC tertanam.</p>
                          <a href="<?php echo base_url('id/len_visual_control_panel') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
                        </div>
                      </div>
                    </div>
                  </div>
