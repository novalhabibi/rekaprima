                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-md-9">                            
                            ...
                            <p style="text-align: justify;">PT Len Industri memproduksi perangkat untuk mengatur suplai listrik ke tiap - tiap perangkat persinyalan yang terpasang disuatu stasiun dengan nama MDP (Main Distribution Panel), perangkat ini mempunyai fitur – fitur, yaitu:</p>
                            <ol style="list-style-type: lower-number;">
                                <li style="text-align: justify;">Mengatur suplai listrik mana yang digunakan (PLN atau Genset) secara otomatis maupun manual</li>
                                <li style="text-align: justify;">Menampilkan jam kerja Genset</li>
                                <li style="text-align: justify;">Menampilkan besaran tegangan dan arus yang digunakan</li>
                            </ol>
                            <p></p>
                        </div>
