            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/telecommunication_systems') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
              ...
              <div class="pin-wrapper">
                ...
                <div class="divider divider-primary divider-small mb-xl">
                  ...
                  <ul class="nav nav-list mb-xl show-bg-active">
                    <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/len_telecommunication_systems') ?>">Len Telecommunication Systems</a></li>
          ...
          <div class="col-md-9">
            <div class="row">
              <div class="col-lg-12 col-md-12" style="height: 200px;">
                ...
                <p style="text-align: justify;">Len Telecommunication Systems adalah kumpulan node dan tautan untuk mengaktifkan telekomunikasi. Telekomunikasi adalah komunikasi pada jarak jauh menggunakan sinyal listrik atau gelombang elektromagnetik.</p>
                <a href="<?php echo base_url('id/len_telecommunication_systems') ?>" class="btn btn-primary btn-block" style="border-color: #0068a5 #0068a5 #035381">Details</a>
              </div>
