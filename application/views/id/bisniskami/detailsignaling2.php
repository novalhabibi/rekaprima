            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_local_interface') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/signalling2.jpg') ?>);height:250px;">
                    ...
                    <div class="row">
                      ...
                      <div class="col-md-9">                            
                          ...
                          <p style="text-align: justify;">PT Len Industri memproduksi perangkat interface dengan nama LCP (Local Control Panel) dan VDU (Visual Display Unit) yang berfungsi untuk memantau fungsi perangkat persinyalan outdoor yang terpasang di suatu stasiun diantaranya :</p>
                        <ol style="list-style-type: lower-number;">
                        <li style="text-align: justify;">Sinyal</li>
                        ...
                        <p style="text-align: justify;">Selain itu, LCP dan VDU pun menampilkan posisi KA di suatu stasiun dan juga menampilkan status sumber listrik yang sedang digunakan untuk interlocking (PLN atau Genset).</p>
                        <p></p>
                      </div>
                    </div>
                  </div>
