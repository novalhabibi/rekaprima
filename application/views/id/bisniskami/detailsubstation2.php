            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_visual_control_panel') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                ...
                <div class="container">
                  ...
                  <div class="row">
                    <div class="col-lg-12 col-md-12" style="height: 200px;">
                      ...
                      <p style="text-align: justify;">Len Substaions Systems memiliki fungsi untuk menghubungkan dan mengumpulkan data dari semua RTU yang terhubung ke jaringan, termasuk data base, program aplikasi, dan pemrosesan data. Semua fungsi ini akan disediakan oleh perangkat lunak runtime dari Power SCADA. PC server ini dikonfigurasi sebagai redundan untuk memastikan kehandalan data. Jika terjadi kegagalan pada komputer utama, komputer backup dapat mengambil alih semua fungsi komputer utama dalam waktu kurang dari 1 detik, dan peralihan ini ditangani oleh perangkat lunak runtime dari Power SCADA.</p>
                    </div>
                  </div>
                </div>
              </div>
