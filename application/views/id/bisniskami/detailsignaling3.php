            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/len_axle_counter') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
            ...
            <div class="container">
                    <div class="row">
                      ...
                      <div class="col-md-9">                            
                        ...
                        <p style="text-align: justify;">Axle Counter adalah perangkat di stasiun yang mendeteksi kereta yang lewat alih-alih sirkuit trek Counting head (atau 'titik deteksi') dipasang di setiap ujung bagian.</p>
                        <p style="text-align: justify;">PT Len Industri membangun kerjasama dengan ALTPRO d.o.o. untuk membangun persinyalan perkeretaapian khususnya untuk peralatan penghitung gandar (Axle Counter) dengan perangkat indoor yang diberi nama BO23-UNUR dan perangkat outdoor yang diberi nama Wheel Sensor ZK24-2 NG, peralatan ini berfungsi agar PPKA dapat mengetahui posisi kereta didalam suatu stasiun. </p>
                        <p style="text-align: justify;">Perangkat ini sudah terpasang di stasiun lintas Sumatera – Jawa, diantaranya sebagai berikut :</p>
                        <ol style="list-style-type: lower-number;">
                            <li style="text-align: justify;">Proyek Double Track Semarang Tawang - Sulur Dengan jumlah 13 stasiun</li>
                            <li style="text-align: justify;">Proyek Double Track Doplang - Surabaya Kota dengan jumlah 23 stasiun</li>
                            <li style="text-align: justify;">Proyek Citayam - Nambo dengan jumlah 3 stasiun</li>
                            <li style="text-align: justify;">Proyek Jogja - Solo dengan jumlah 9 stasiun</li>
                            <li style="text-align: justify;">Proyek Lintas Sumatera (Stasiun Kisaran, Kertapati, Tiga Gajah dan Tarahan)</li>
                        </ol>
                        <p></p>
                      </div>
                    </div>
