    ...
    <div class="col-md-4">
        <div class="thumb-info custom-thumb-info-4 animateme scrollme" data-when="enter" data-from="0.5" data-to="0"
            ...
            <div class="thumb-info-wrapper"><img
                    src="<?php echo $maintenance->gambar_maintenance ?>" class="img-responsive" />
            </div>
            <div class="thumb-info-caption custom-box-shadow" style="border-bottom : 1px solid #0e85ca;">
                <div class="thumb-info-caption-text">
                    <h4 class="text-center"><a href="<?php echo base_url('id/maintenance/') ?><?php echo $maintenance->link_maintenance ?>" class="text-color-dark"> <?php echo $maintenance->nama_maintenance ?></a></h4>
                    <p class="justify"> <?php echo $maintenance->deskripsi_maintenance ?></p>
                </div>
            </div>
        </div>
    </div>
