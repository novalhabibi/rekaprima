            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/news_2019_synergy_industrial_and_educational') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
          ...
          <div class="col-md-9">
            <div class="blog-post single-post">
              <article class="post blog-single-post">
                ...
                <div class="">
                  <h2>Sinergi Industri dan Pendidikan </h2>
                  <div class="post-meta">
                    ...
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">Pemerintah masih kesulitan untuk membangun sinergi antara dunia pendidikan di Indonesia dengan industri. Berbagai upaya yang dilakukan selama 20 tahun terakhir belum mampu membuahkan hasil. Pemerintah sendiri sudah melakukan berbagai upaya untuk menyelaraskan sekolah dengan industri.&nbsp;</p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">Terakhir, melalui Instruksi Presiden Nomor 9/2016 tentang Revitalisasi SMK yang semakin mendorong industri dan SMK melaksanakan pendidikan yang sesuai dengan kebutuhan kedua belah pihak. Sejauh ini ada sekitar 100 SMK yang sudah menjalin kerja sama dengan industri.&nbsp;</p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">PT Len Rekaprima Semesta merupakan salah satu industri yang juga berusaha mendorong terciptanya Link and Match antara industri dan dunia pendidikan.</p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">Dengan program praktek kerja lapangan(PKL), magang, on job training, sampai program penyerapan tenaga siap kerja dari sekolah vokasi telah dilakukan untuk mendorong terciptanya Link and Match antara industri dan dunia pendidikan tersebut.</p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">Pada akhir bulan April dan awal Mei yang lalu, PT Len Rekaprima Semesta melakukan program sinergi antara industri dan dunia pendidikan dengan melakukan perekrutan tenaga dari SMKN 1 Jakarta dan Akademi Perkeretaapian Indonesia Madiun.</p>
                    <p style="text-align: justify;"></p>
                    <p style="text-align: justify;">Harapannya, tenaga baru ini dapat turut serta berkontribusi dalam proyek-proyek perkeretaapian yang sedang dijalankan oleh PT Len Rekaprima Semesta, dan menjadi tenaga kerja yang handal dan kompeten di masa yang akan datang.</p>
