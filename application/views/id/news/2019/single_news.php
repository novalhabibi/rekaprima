...
$slug = "dari-mana-saya-bisa-mendapatkannya";


$CI = & get_instance();
$CI->load->model('newsmodel');
$news = $CI->newsmodel->getBySlug($slug)->row();

echo $news->judul;
// $maintenancewherecategory = $CI->maintenancesmodel->getByIdKategori($datadetailmaintenances->id_kategori_kategori_maintenance);
                        ...
                        <div class="blog-post single-post">
                            <article class="post blog-single-post">
                                ...
                                <div class="">
                                    ...
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Jakarta – Untuk ketiga kalinya, pameran
                                        perkeretaapian RailwayTech Indonesia 2019 kembali digelar. Pameran yang bakal
                                        berlangsung pada 20-22 Maret 2019 di JIEXpo Kemayoran tersebut diharapkan mampu
                                        menarik investasi untuk sektor industri kereta api nasional.&nbsp;</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">“Melalui pameran ini, investor dalam dan luar negeri
                                        akan bertemu. Dari pertemuan itu, potensi investasi yang datang untuk Indonesia
                                        akan sangat besar,’ kata Direktur PT Global Expo Management (GEM) Baki Lee
                                        selaku penyelenggara pameran, di Pembukaan Pameran, di JIEXPO, Jakarta, Rabu
                                        (20/3/2019).&nbsp;</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Kereta api menjadi salah satu transportasi umum
                                        pilihan masyarakat Indonesia.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Armada yang sudah semakin banyak dengan beragam
                                        fasilitas selalu ditingkatkan Pemerintah demi kepuasan masyarakat.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Menurut Visi Kereta Api Nasional 2030, proyek-proyek
                                        perkeretaapian Indonesia akan diimplementasikan hingga 2030 dengan nilai
                                        inveslasi lebih dari USD 67 miliar yang akan digunakan untuk membangun LRT, MRT,
                                        Kereta Api Berkecepatan Tinggi, Peremajaan Rolling Stock, dan lain-lain.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Selain LRT Jakarta dan LRT Jabodebek, pembangunan
                                        MRT di lbu kota (Jakarta) sudah masuk ke dalam tahap finishing, dimana kereta
                                        api cepat ini akan siap beroperasi pada Marat 2019 dengan rentang sepanjang
                                        kurang lebih 16 kilometer di tahap pertama.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">MRT Jakarta diproyeksikan akan melayani sektiar
                                        173.400 penumpang setiap harinya dan untuk lahap kedua akan mulai dilaksanakan
                                        pada awal 2019. MRT (Mass Rapid Transport) dan LRT (Light Rapid Transport) yang
                                        dikerjakan bersamaan akan rampung di tahun 2019 dan di perkirakan akan
                                        dioperasikan di bulan Februari 2019.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Kedua moda transportasi ini akan terintegrasi dengan
                                        jalur Transjakarta yang akan memudahkan masyarakat.</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Perkembangan ini tidak akan sempurna jika tidak
                                        didukung dengan inovasi teknologi terbaik di bidangnya. Karena itu, GEM
                                        Indonesia berkomitmen untuk mendukung pembangunan dan perkembangan infrastruktur
                                        yang sedang giat dilakukan. Bekerjasama dengan Masyarakat Perkeretaapian
                                        Indonesia (MAKA).</p>
                                    <p style="text-align: justify;"></p>
                                    <p style="text-align: justify;">Pameran ini menjadi ajang untuk memamerkan teknologi
                                        dan inovasi terbaru di bidang infrastruktur dan sistem perkeretaapian untuk
                                        mendukung pembangunan kereta api nasional.</p>
