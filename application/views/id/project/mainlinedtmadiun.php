...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Double Track Madiun – Jombang | PT Len Rekaprima Semesta</title>
...
<body>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> Double Track Madiun - Jombang</a></li>
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_madiun_jombang') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
  ...
  <div class="main" role="main">
    <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/dtmadiun.jpg') ?>);height:250px;"></section>
    <div class="container">
      <div class="row">
        <div class="col-md-3">
          <aside class="siderbar">
            <div class="pin-wrapper">
              ...
              <ul class="nav nav-list mb-xl show-bg-active">
                ...
                <li><a data-hash="" data-hash-offset="110" href="#">Double Track Madiun - Jombang</a></li>
        ...
        <div class="col-md-9">                            
          <h3><strong>DOUBLE TRACK MADIUN - JOMBANG</strong></h3>
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Track Madiun – Jombang dilakukan parsial sesuai serah terima proyek instalasi. Pekerjaan perawatan fasilitas operasi yang pertama dilakukan per bulan Maret 2019 adalah stasiun Nganjuk, Sukomoro dan Baron sedangkan pekerjaan perawatan fasilitas operasi berikutnya sesuai serah terima proyek instalasi per bulan April 2019 adalah stasiun Babadan, staisun Caruban, Stasiun Saradan, IB Wilangan, dan stasiun Bagor. Beberapa yang akan diproyeksikan untuk perawatan pada tahun 2019 lainnya di Double Track Madiun – Jombang adalah stasiun  Kertosono, stasiun Sembung dan stasiun Jombang.</P>
          <p></p>
          <div class="post-image">
            <div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
              <div>
                <div class="img-thumbnail">
                  <img class="img-responsive" src="<?php echo base_url('assets/media/image/maps/madiun-jombang.jpg') ?>" alt="">
                </div>
              </div>
            </div>
          </div>
