            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_solo_kedungbanteng') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
      <div class="row">
          ...
          <aside class="siderbar">
            <div class="pin-wrapper">
              ...
              <ul class="nav nav-list mb-xl show-bg-active">
                ...
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_kroya_kutoarjo') ?>">Double Track Kroya - Kutoarjo</a></li>
        ...
        <div class="col-md-9">                            
          ...
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Track Solo -  Kedung Banteng dilakukan parsial sesuai serah terima proyek instalasi. Pekerjaan perawatan fasilitas operasi yang pertama dilakukan per bulan Maret 2019 adalah sebagai berikut :</P>
          <ol style="list-style-type: lower-number;">
            <li style="text-align: justify;">Stasiun Palur</li>
            <li style="text-align: justify;">Stasiun Kemiri</li>
            <li style="text-align: justify;">Stasiun Masaran</li>
            <li style="text-align: justify;">Stasiun Sragen</li>
            <li style="text-align: justify;">Stasiun Kebonromo</li>
            <li style="text-align: justify;">Stasiun Kedung Banteng</li>
          </ol>
          <p style="text-align: justify;">Stasiun berikutnya yang akan diproyeksikan pekerjaan fasiitas operasi di Double Track Solo – Kedungbanteng pada bulan Mei 2019 adalah stasiun Solo Jebres.</P>
          <p></p>
