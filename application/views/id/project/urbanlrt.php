...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>LRT Sumatera Selatan | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                      ...
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            ...
                            <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> LRT Sumatera Selatan</a></li>
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_lrt') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
                        ...
                        <aside class="siderbar">
                          <div class="pin-wrapper">
                            ...
                            <ul class="nav nav-list mb-xl show-bg-active">
                              ...
                              <li><a data-hash="" data-hash-offset="110" href="#">LRT Sumatera Selatan</a></li>
                              <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_mrt') ?>">MRT Jakarta</a></li>
                            </ul>
                          </div>
                        </aside>
                      </div>
                      <div class="col-md-9">                            
                        <h3><strong>LRT SUMATERA SELATAN</strong></h3>
                        <p style="text-align: justify;">Sistem fasilitas operasi LRT (Light Rail Train) Sumatera Selatan telah berjalan dan beroperasi pada dasarnya untuk menunjang selama Asian Games 2018 yang dilaksanakan pada bulan Agustus-September 2018 lalu. PT. Len Rekaprima Semesta turut andil dalam memelihara perangkat fasilitas operasi saat beroperasi KA LRT di Sumatera Selatan. Fasilitas operasi ini berkaitan dengan sistem persinyalan, telekomunikasi, power system, traksi yang menggunakan 3rd rail, perangkat automatic train protection atau pengaman kereta otomatis dan perangkat yang ada di pusat kendali atau Operation Control Centre. PT. Len Rekaprima Semesta melakukan perawatan yang ada di LRT Sumatera Selatan sejumlah 13 stasiun dan 1 Depo. Stasiun tersebut terdiri dari, yaitu :</P>
                        <ol style="list-style-type: lower-number;">
                          <li style="text-align: justify;">Stasiun Bandara International Sultan Mahmud Badarudin</li>
                          <li style="text-align: justify;">Stasiun Asrama Haji</li>
                          <li style="text-align: justify;">Stasiun Punti Kayu</li>
                          <li style="text-align: justify;">Stasiun RSUD</li>
                          <li style="text-align: justify;">Stasiun Garuda Dempo</li>
                          <li style="text-align: justify;">Stasiun Demang Lebar Daun</li>
                          <li style="text-align: justify;">Stasiun Bumi Sriwijaya</li>
                          <li style="text-align: justify;">Stasiun Dishub</li>
                          <li style="text-align: justify;">Stasiun Cinde</li>
                          <li style="text-align: justify;">Stasiun Ampera</li>
                          <li style="text-align: justify;">Stasiun Gubernur Bestari</li>
                          <li style="text-align: justify;">Stasiun Jakabaring</li>
                          <li style="text-align: justify;">Stasiun DJKA</li>
