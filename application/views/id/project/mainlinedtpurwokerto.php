            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_purwokerto_kroya') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
      <div class="row">
          ...
          <aside class="siderbar">
            <div class="pin-wrapper">
              ...
              <ul class="nav nav-list mb-xl show-bg-active">
                ...
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_cirebon_surabaya') ?>">Double Track Cirebon - Surabaya</a><li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_kedungbanteng_madiun') ?>">Double Track Kedung Banteng - Madiun</a></li>
        ...
        <div class="col-md-9">                            
          ...
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Track Purwokerto – Kroya dilakukan parsial sesuai serah terima proyek instalasi. Pekerjaan perawatan fasilitas operasi yang pertama dilakukan per bulan Februari 2019 adalah stasiun Randegan dan stasiun Kebasen sedangkan pekerjaan perawatan fasilitas operasi berikutnya sesuai serah terima proyek instalasi per bulan Maret 2019 adalah stasiun Purwokerto dan stasiun Notog. Tidak hanya perawatan pada masing-masing stasiun di lintas Double Track Purwokerto – Kroya, tetapi juga dikarenakan pengaktifan CTC (Centralized Train Control) di pusat kendali operasi kereta api milik PT. Kereta Api Indonesia per bulan akhir April 2019.</P>
          <p></p>
