            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_kroya_kutoarjo') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
      <div class="row">
          ...
          <aside class="siderbar">
            <div class="pin-wrapper">
              ...
              <ul class="nav nav-list mb-xl show-bg-active">
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_baturaja_martapura') ?>">Double Track Baturaja - Martapura</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_cirebon_surabaya') ?>">Double Track Cirebon - Surabaya</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_kedungbanteng_madiun') ?>">Double Track Kedung Banteng - Madiun</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_kertapati_prabumulih') ?>">Double Track Kertapati - Prabumulih</a></li>
                <li><a data-hash="" data-hash-offset="110" href="#">Double Track Kroya - Kutoarjo</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_madiun_jombang') ?>">Double Track Madiun - Jombang</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_purwokerto_kroya') ?>">Double Track Purwokerto - Kroya</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_solo_kedungbanteng') ?>">Double Track Solo - Kedung Banteng</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_solo_jogja') ?>">Double Track Solo - Jogja</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_manggarai_cikarang') ?>">Double Double Track Manggarai - Cikarang</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_bandartinggi_kualatanjung') ?>">Persinyalan Elektrik Bandar Tinggi - Kuala Tanjung</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_binjai_besitang') ?>">Persinyalan Elektrik Binjai - Besitang</a></li>
                <li><a data-hash="" data-hash-offset="110" href="<?php echo base_url('id/proyek_medan_kualanamu') ?>">Persinyalan Elektrik Medan - Kualanamu</a></li>
              </ul>
            </div>
          </aside>
        </div>
        <div class="col-md-9">                            
          ...
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Track Kroya – Kutoarjo dilakukan parsial sesuai serah terima proyek instalasi. Pekerjaan perawatan ini dimulai per bulan Februari 2019 untuk stasiun Kroya dan stasiun Kemranjen. Stasiun berikutnya direncanakan untuk stasiun Sumpiuh bulan Mei 2019. Beberapa stasiun yang akan dilakukan perawatan selain ketiga sebelumnya, sebagai berikut  :</P>
          <ol style="list-style-type: lower-number;">
            <li style="text-align: justify;">Stasiun Tambak</li>
            <li style="text-align: justify;">Stasiun Ijo</li>
            <li style="text-align: justify;">Stasiun Gombong</li>
            <li style="text-align: justify;">Stasiun Karanganyar</li>
            <li style="text-align: justify;">IB Soka</li>
            <li style="text-align: justify;">Stasiun Kebumen</li>
            <li style="text-align: justify;">Stasiun Wonosari</li>
            <li style="text-align: justify;">Stasiun Kutowinangun</li>
            <li style="text-align: justify;">Stasiun Prembun</li>
            <li style="text-align: justify;">Stasiun Butuh</li>
            <li style="text-align: justify;">Stasiun Kutoarjo</li>
          </ol>
          <p></p>
