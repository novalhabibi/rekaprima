            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/project_solo_jogja') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-9">                            
          ...
          <p style="text-align: justify;">Pekerjaan perawatan fasilitas operasi di Double Track Solo – Jogja sedang dilakukan per bulan Februari 2019 hingga saat ini. Stasiun dalam masa perawatan fasilitas operasi di Double Track Solo – Jogja adalah sebagai berikut :</P>
          <ol style="list-style-type: lower-number;">
            <li style="text-align: justify;">SIB Ketandan</li>
            <li style="text-align: justify;">Stasiun Ceper</li>
            <li style="text-align: justify;">Stasiun Klaten</li>
            <li style="text-align: justify;">Stasiun Srowot</li>
          </ol>
          <p></p>
