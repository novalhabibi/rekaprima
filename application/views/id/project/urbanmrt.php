    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/urmrt.jpg') ?>);height:250px;">
            </section>
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <div class="pin-wrapper">
                                ...
                                <ul class="nav nav-list mb-xl show-bg-active">
                                    <li><a data-hash="" data-hash-offset="110"
                                            href="<?php echo base_url('id/proyek_apms') ?>">APMS Skytrain</a></li>
                                    <li><a data-hash="" data-hash-offset="110"
                                            href="<?php echo base_url('id/proyek_lrt') ?>">LRT Sumatera Selatan</a></li>
                    ...
                    <div class="col-md-9">
                        ...
                        <p style="text-align: justify;">Semenjak operasional secara komersil pada bulan Maret 2019, PT.
                            MRT Jakarta telah membuat penyiapan operasi dan persiapan institusi hingga sumber daya
                            manusia. Salah satu bagian yang dipersiapkan adalah perawatan pada Platform Screen Door atau
                            partisi pembatas antara peron penumpang dan jalur kereta. Di partisi pembatas ini, terdapat
                            pintu geser otomatis (automated sliding doors) yang digunakan sebagai akses masuk dan keluar
                            penumpang dari kereta, pintu darurat dan pintu keluar masuk masinis. Kebutuhan akan personel
                            perawatan PSD ini melalui proses tender dan PT. Len Rekaprima Semesta memenangkan kontrak
                            pekerjaan perawatan PSD dengan nomer kontrak CON-1/007/PRC-MRT/III/2019. Suatu kebanggaan
                            bagi PT. Len Rekaprima Semesta memperoleh pekerjaan tersebut untuk langkah awal
                            berkembangnya PT. Len Rekaprima Semesta secara mandiri. Pekerjaan perawatan PSD MRT Jakarta
                            untuk 13 stasiun sebanyak 672 unit automated sliding doors, 168 unit emergency doors dan 56
                            unit pintu khusus masinis. PT MRT Jakarta menggunakan dua jenis PSD yaitu full height untuk
                            stasiun bawah tanah dan half height untuk stasiun laying. Stasiun bawah tanah terdiri dari
                            enam stasiun, yaitu Stasiun Senayan, Istora, Bendungan Hilir, Setiabudi, Dukuh atas dan
                            Bunderan Hotel Indonesia, sedangkan stasiun laying terdiri dari tujuh stasiun yaitu stasiun
                            Lebak Bulus, Fatmawati, Cipete Raya, Haji Nawi, Blok A, Blok M, dan Sisingamangaraja.
                            Pekerjaan perawatan PSD MRT Jakarta ini selama dua tahun dalam kontrak yang ditawarkan.</P>
                        <p></p>
                    </div>
                </div>
            </div>
