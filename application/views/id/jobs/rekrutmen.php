...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>Tenaga Berpengalaman | PT Len Rekaprima Semesta</title>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                        ...
                        <div class="col-md-3">
                          <span class="dropdown-mega-sub-title"><h4>Penerimaan Baru</h4></span>
                            <ul class="dropdown-mega-sub-nav">
                              ...
                              <li><a href="#" target="_self"><i class="fa fa-chevron-right" aria-hidden="true"></i> Tenaga Berpengalaman</a></li>
                            </ul>
                        </div>
                      </div>
                    </div>
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('en/rekrutmen') ?>"><img src="<?php echo base_Url('assets/img/blank.gif') ?>" class="flag flag-gb" alt="English" /> English</a>
                  </li>
                </ul>
              </li>
            </ul>
