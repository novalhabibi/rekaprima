    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/rekrutmen.jpg') ?>);height:430px;">
            </section>
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-9">
                        <div class="blog-posts">
                            <article class="post blog-single-post">
                                <div class="">
                                    <div class="post-meta">
                                        <span><i class="fa fa-calendar bold"> Expired 29 Juni 2019</i><i class="bold"
                                                style="color: #eb2929">(Closed)</i></span>
                                    </div>
                                    <table class="table table-bordered">
                                        ...
                                        <tr>
                                            <td>Bertanggung jawab, jujur, berintergitas, motivasi tinggi dan bisa
                                                bekerja dengan tim</td>
                                        </tr>
                                        <tr>
