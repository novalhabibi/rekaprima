...
<head>
    ...
    <title><?= $datadetailmaintenances->name_maintenance_en ?> | PT Len Rekaprima Semesta</title>
                    ...
                    <div class="col-md-3">
                        <aside class="siderbar">
                            <div class="pin-wrapper">
                                <h3 class="mb-none"><?= $datadetailmaintenances->name_maintenance_en ?>s</h3>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-lg-12 col-md-12" style="height: 200px;">
                                <h3><strong><?= $datadetailmaintenances->name_maintenance_en ?>S</strong></h3>
                                <p style="text-align: justify;"><?= $maintenancekategori->description_maintenance_en ?></p>
                            </div>
                        </div>
                    </div>
                </div>
