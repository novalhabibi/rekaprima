    ...
    <div class="body sticky-header-active">
        ...
        <div class="main" role="main">
            <section class="page-header page-header-custom-background"
                style="background-image:url(<?php echo base_url('assets/media/image/telecommunication2.jpg') ?>);height:250px;">
            </section>
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                            ...
                            <div class="pin-wrapper">
                                ...
                                <ul class="nav nav-list mb-xl show-bg-active">
                                    <li><a data-hash="" data-hash-offset="110"
                                            href="<?php echo base_url('en/len_telecommunication_systems') ?>">Len
                                            Telecommunication Systems</a></li>
                                    <li><a data-hash="" data-hash-offset="110" href="#">Len Telecommunication Rack</a>
                                    </li>
                                </ul>
                            </div>
                        </aside>
                    ...
                    <div class="col-md-9">
                        <div class="row">
                            <div class="col-lg-12 col-md-12" style="height: 200px;">
                                ...
                                <p style="text-align: justify;">Len Telecommunication Systems is a collection of nodes
                                    and links to activate telecommunications. Telecommunications is communication at a
                                    distance using electrical signals or electromagnetic waves.</p>
                                <a href="<?php echo base_url('en/len_telecommunication_systems') ?>"
                                ...
                                <div class="row">
                                    <div class="col-md-4" style="height: 500px;">
                                        <div class="thumb-info custom-thumb-info-4">
                                            <img src="<?php echo base_url('assets/media/image/len_telecommunication.jpg') ?>"
                                                class="img-responsive" caption="false" width="369" height="184">
                                        </div>
                                        <h3>LEN TELECOMMUNICATION RACK</h3>
                                        <p style="text-align: justify;">Len Telecommunication Rack adalah solusi lengkap
                                            untuk mengirimkan data dan komunikasi suara antar stasiun.</p>
