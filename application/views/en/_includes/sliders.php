...
<div id="carousel-example-generic" class="carousel slide">
                    ...
                    <div class="carousel-inner" role="listbox">
                        <div class="item active">
                            ...
                            <div class="carousel-caption animated fadeInLeft">
                                ...
                                <h4 class="slide-text-desc" data-animation="animated bounceInUp">
                                    <h4 style="text-align: left;"><span><?= $singleslider->description ?><br /></span></h4>
                                </h4>
                            </div>
                        </div>
                        <?php
                        ...
                        <div class="item ">
                            <img src="<?php echo base_Url() ?><?= $slider->picture ?>"
                                class="img-responsive" />
                            <div class="carousel-caption animated fadeInLeft">
                                <h2 class="slide-text-heading" data-animation="animated bounceInLeft">
                                    <?= $slider->title ?>
                                ...
                                <h4 class="slide-text-desc" data-animation="animated bounceInUp">
                                    <h4><span style="color: #ffffff;"><?= $slider->description ?></span></h4>
                                </h4>
                            </div>
                        </div>
                        <?php
