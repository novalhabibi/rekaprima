...
<body>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                    ...
                    <div class="dropdown-mega-content container">
                      <div class="row">
                        ...
                        <div class="col-md-3">
                          ...
                          <ul class="dropdown-mega-sub-nav">
                            <li><a href="#" target="_self"><i class="fa fa-chevron-right" aria-hidden="true"></i> News</a></li>
                          </ul>  
                        </div>
                      </div>
                    </div>
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('id/news') ?>"><img src="<?php echo base_url('assets/img/blank.gif') ?>" class="flag flag-id" alt="Indonesia" /> Indonesia</a>
                  </li>
                </ul>
              </li>
            </ul>
  ...
  <div class="main" role="main">
    <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/news2.jpg') ?>);height:250px;">                
    </section>
    <div class="container">
      <div class="row">
        <div class="col-md-9">                
                ...
                <div class="col-md-5">
                  <div class="post-image">
                    <div class="img-thumbnail">
                      <img src="<?php echo base_url('assets/media/image/event/newevent6.jpg') ?>" alt="" class="img-responsive" />
                      </div>
                  </div>
                </div>
                <div class="col-md-7">
                  <div class="post-content">
                    <h4><a href="<?php echo base_url('en/news_2019_synergy_industrial_and_educational') ?>">Synergy Industrial and Educational</a></h4>
                    <div class="post-meta">
            ...
            <article class="post post-medium">
              <div class="row">
                <div class="col-md-5">
                  <div class="post-image">
                    <div class="img-thumbnail">
                      <img src="<?php echo base_url('assets/media/image/event/newevent1.jpg') ?>" alt="" class="img-responsive" />
                      </div>
                  </div>
                </div>
                <div class="col-md-7">
                  <div class="post-content">
                    <h4><a href="<?php echo base_url('en/news_2019_indonesia_railway_conference') ?>">Indonesia Railway Conference 2019</a></h4>
                    <div class="post-meta">
                      <span class="label label-secondary">News</span>
