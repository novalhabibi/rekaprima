...
<body>
            ...
            <ul class="nav nav-pills container" id="mainNav">
                          ...
                          <div class="col-md-3">
                            <span class="dropdown-mega-sub-title"><h4>Company Profile</h4></span>
                              <ul class="dropdown-mega-sub-nav">
                                ...
                                <li><a href="#"><i class="fa fa-chevron-right" aria-hidden="true"></i> Organization Structure</a></li>
                              </ul>
                          </div>
                          <div class="col-md-3">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('id/struktur_organisasi') ?>"><img src="<?php echo base_url('assets/img/blank.gif') ?>" class="flag flag-id" alt="Indonesia" /> Indonesia</a>
                  </li>
                </ul>
              </li>
            </ul>
  ...
  <div class="main" role="main">
    <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/strukturbanner.jpg') ?>);height:250px;">                
    </section>
    <div class="container">
      <div class="row">
        <div class="divider devider-primary"></div>
        <div class="col-md-12 center">
          <img src="<?php echo base_url('assets/media/image/struktur.png') ?>" class="img-responsive">
        </div>
      </div>
    </div>
  </div>
