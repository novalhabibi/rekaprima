...
$kategoriproject = $CI->projectsmodel->getByIdKategori($datadetailprojects->id_kategori_kategori_project);
...
<head>
    ...
    <title><?= $datadetailprojects->name_project_en ?> | PT Len Rekaprima Semesta</title>
        ...
        <div class="main" role="main">
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-3">
                        <aside class="siderbar">
                            <div class="pin-wrapper">
                                <h3 class="mb-none">Proyek <strong><?= $datadetailprojects->nama_kategori_project ?></strong></h3>
                                <div class="divider divider-primary divider-small mb-xl">
                                    <hr>
                                </div>
                                <ul class="nav nav-list mb-xl show-bg-active">
                                <?php
                                $dataprojekwherekategori = $this->projectsmodel->getByIdKategori($datadetailprojects->id_kategori_kategori_project);
                                foreach ($dataprojekwherekategori as $projekkat) {
                                    # code...
                                
                                ?>
                                    <li><a data-hash="" data-hash-offset="110"
                                            href="<?php echo base_url('en/project/') ?><?= $projekkat->link_project_en ?>"><?= $projekkat->name_project_en ?></a></li>
                                <?php
                                }
                                ?>
                    ...
                    <div class="col-md-9">
                        <h3><strong><?= $datadetailprojects->name_project_en ?></strong></h3>
                        <p style="text-align: justify;"><?= $datadetailprojects->description_project_en ?></p>
                        <div class="post-image">
                            <div class="owl-carousel owl-theme" data-plugin-options="{'items':1}">
                                <div>
                                    <div class="img-thumbnail">
                                        <img class="img-responsive"
                                            src="<?= $datadetailprojects->gambar_project ?>"
                                            alt="">
                                    </div>
                                </div>
                            </div>
