            ...
            <ul class="nav nav-pills container" id="mainNav">
              ...
              <li>
                ...
                <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                  <li>
                    <a href="<?php echo base_url('id/beranda') ?>"><img src="<?php echo base_url('assets/img/blank.gif') ?>" class="flag flag-id" alt="Indonesia" /> Indonesia</a>
                  </li>
                </ul>
              </li>
            </ul>
    ...
    <div id="carousel-example-generic" class="carousel slide">
      ...
      <div class="carousel-inner" role="listbox">
        <div class="item active">
          <img src="<?php echo base_url('assets/media/image/slider/Rekaprima_51.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              ...
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
               <h4 style="text-align: left;"><span>Len Rekaprima Semesta always makes sure to maintain the functionality of the railway system equipment on periodically.<br /></span></h4>
              </h4>
            </div>
        </div>
        <div class="item ">
          <img src="<?php echo base_Url('assets/media/image/slider/Rekaprima_44.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              ...
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
               <h4><span style="color: #ffffff;">Maintain a system supported by PT. Len Rekaprima Semesta as a subsidiary of PT. Len Railway Systems.</span></h4>
              </h4>
            </div>
        </div>
        <div class="item ">
          <img src="<?php echo base_url('assets/media/image/slider/Rekaprima_43.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              ...
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
                <h4><span style="color: #ffffff;">Become the most reliable world-class partner for the Railway Systems.</span></h4>
              </h4>
            </div>
        </div>
        <div class="item ">
          <img src="<?php echo base_url('assets/media/image/slider/Rekaprima_50.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              ...
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
                <h4><span style="color: #ffffff;">Len Rekaprima Semesta is always ready to provide quality in accordance with customer demand, and provide the best service.</span></h4>
              </h4>
            </div>
        </div>
        <div class="item ">
          <img src="<?php echo base_url('assets/media/image/slider/Rekaprima_52.jpg') ?>" class="img-responsive" />
            <div class="carousel-caption animated fadeInLeft">
              <h2 class="slide-text-heading" data-animation="animated bounceInLeft">
                TOTAL
              </h2>
              <h4 class="slide-text-desc" data-animation="animated bounceInUp">
                <h4><span style="color: #ffffff;">Contributing to improving people's productivity and mobility through a reliable and safe Railway System.</span></h4>
              </h4>
            </div>
        </div>
      </div><!-- /.carousel-inner -->
...
<div class="container">
  ...
  <div class="row mt-md mb-xl">
    ...
    <div class="col-md-6">
      <p class="justify">PT. Len Rekaprima Semesta is a growing company and is a subsidiary of one of the State-Owned Enterprises PT. Len Industri (Persero), which is engaged in Operation & Maintenance of Railways. To support the needs of human resources and with the rapid development of the business world, PT. Len Rekaprima Semesta invites qualified individuals to be able to join and advance with our company. We have never collected any fees in the recruitment process. We have never worked with travel agents in certain travel agencies in the recruitment process.</p>
        <div class="center">
          <img src="<?php echo base_url('assets/media/image/iso-rekaprima.jpg') ?>" style="width: 50%">
        </div>
    </div>
    <img src="<?php echo base_url('assets/media/image/maps/maps.jpg') ?>" style="width: 100%">
  </div>
<div class="container">
  <div class="row">
    <div class="col-md-12 center">
          ...
          <div class="col-md-7">
            <div class="owl-carousel owl-theme" data-plugin-options="{'items': 1, 'margin': 10, 'autoplay':true}">
              <div class="box-item">
                <div class="box-post">
                  <h1 class="post-title">
                    <a href="<?php echo base_url('en/news_2019_synergy_industrial_and_educational') ?>">
                ...
                <img src="<?php echo base_url('assets/media/image/event/newevent6.jpg') ?>" alt="Indonesia Railway Conference 2019" class="img-responsive">
              </div>
            </div>
          </div>
          <div class="col-md-5">
              ...
              <li>
                <div class="post-image">
                  <div class="img-thumbnail">
                    <a href="<?php echo base_url('en/news_2019_indonesia_railway_conference') ?>">
                      <img src="<?php echo base_url('assets/media/image/event/newevent1.jpg') ?>" alt="Indonesia Railway Conference 2019" style="width:92px; height:76px;">
                    </a>
                  </div>
                </div>
                <div class="post-info">
                  <a href="<?php echo base_url('en/news_2019_indonesia_railway_conference') ?>">Indonesia Railway Conference 2019</a>
                  <div class="post-meta">
