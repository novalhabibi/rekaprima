                            ...
                            <ul class="nav nav-pills container" id="mainNav">
                                <li style="float: left">
                                    <div class="logo col-md-3 logo-collapse-nav">
                                        <a href="<?php echo base_url('en/home') ?>">
                                            <img alt="Len Rekaprima Semesta" width="110" height="50"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('en/who_we_are') ?>"><i
                                                                        ...
                                                                        aria-hidden="true"></i> Who We Are</a></li>
                                                            <li><a href="<?php echo base_url('en/history') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> History Len Rekaprima
                                                                    Semesta</a></li>
                                                            <li><a href="<?php echo base_url('en/vision_mission') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Vision &amp; Mission</a>
                                                            </li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/organization_structure') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('en/management') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Management</a></li>
                                                            <li><a href="<?php echo base_url('en/commissioners') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Board of
                                                                    Commissioners</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-mega-content container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <?php
                                                            foreach ($kategorimaintenances->result() as $kategorimaintenances) {
                                                              
                                                            ?>
                                                            <li><a
                                                                    href="<?php echo base_url('id/signalling_systems') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i>
                                                                    <?=  $kategorimaintenances->name_kategori_maintenance_en ?></a>
                                                            </li>
                                                            <?php
                                                            }
                                                            ?>
                                            ...
                                            <div class="dropdown-mega-content container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_baturaja_martapura') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Baturaja -
                                                                    Martapura</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_cirebon_surabaya') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Cirebon -
                                                                    Surabaya</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_kedungbanteng_madiun') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kedung
                                                                    Banteng - Madiun</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_kertapati_prabumulih') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kertapati -
                                                                    Prabumulih</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_kroya_kutoarjo') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Kroya -
                                                                    Kutoarjo</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_madiun_jombang') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Madiun -
                                                                    Jombang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_purwokerto_kroya') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Purwokerto
                                                                    - Kroya</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_solo_kedungbanteng') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Solo -
                                                                    Kedung Banteng</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_solo_jogja') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Track Solo -
                                                                    Jogja</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_manggarai_cikarang') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Double Double Track
                                                                    Manggarai - Cikarang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_bandartinggi_kualatanjung') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Electrical Signaling
                                                                    Bandar Tinggi - Kuala Tanjung</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_binjai_besitang') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Electrical Signaling
                                                                    Binjai - Besitang</a></li>
                                                            <li><a
                                                                    href="<?php echo base_url('en/project_medan_kualanamu') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Electrical Signaling
                                                                    Medan - Kualanamu</a></li>
                                                        </ul>
                                                    </div>
                                                    <div class="col-md-3">
                                                        <span class="dropdown-mega-sub-title">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('en/project_apms') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> APMS Skytrain</a></li>
                                                            <li><a href="<?php echo base_url('en/project_lrt') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> LRT South Sumatra</a>
                                                            </li>
                                                            <li><a href="<?php echo base_url('en/project_mrt') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> MRT Jakarta</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            ...
                                                            <li><a href="<?php echo base_url('en/rekrutmen') ?>"><i
                                                                        class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> Experienced Staff</a>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="dropdown-mega-content container">
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-3">
                                                        ...
                                                        <ul class="dropdown-mega-sub-nav">
                                                            <li><a href="<?php echo base_url('en/news') ?>"
                                                                    target="_self"><i class="fa fa-chevron-right"
                                                                        aria-hidden="true"></i> News</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <li>
                                    ...
                                    <ul class="dropdown-menu dropdown-menu-right" aria-labelledby="dropdownLanguage">
                                        <li>
                                            <a href="<?php echo base_url('id/beranda') ?>"><img
                                                    src="<?php echo base_url('assets/img/blank.gif') ?>"
    ...
    <div class="wrap_load">
        <div class="container">
            ...
            <div class="row mt-md mb-xl">
                ...
                <div class="col-md-6">
                    <p class="justify">PT. Len Rekaprima Semesta is a growing company and is a subsidiary of one of the
                        State-Owned Enterprises PT. Len Industri (Persero), which is engaged in Operation & Maintenance
                        of Railways. To support the needs of human resources and with the rapid development of the
                        business world, PT. Len Rekaprima Semesta invites qualified individuals to be able to join and
                        advance with our company. We have never collected any fees in the recruitment process. We have
                    ...
                    <div class="col-md-4">
                        <div class="thumb-info custom-thumb-info-4 animateme scrollme" data-when="enter" data-from="0.5"
                            ...
                            <div class="thumb-info-caption custom-box-shadow"
                                style="border-bottom : 1px solid #0e85ca;">
