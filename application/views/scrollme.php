...
<head>
	...
	<link rel="author" title="Nick Pearson" href="http://nckprsn.com/">

	<meta name="viewport" content="width=device-width, initial-scale=1.0, user-scalable=no">

	<link rel="stylesheet" href="<?php echo base_url('assets/css/skins/style.css') ?>" media="screen">
...
<body>
	...
	<header class="header">
		...
		<div class="wrapper">
			...
			<nav class="nav nav_offsite">
				<ul class="plain clearfix">
					<li class="nav_item_button button button_alt"><a href="http://codepen.io/nckprsn/pen/IGpmc"><span class="longtext">Play on </span>CodePen</a></li>
					<li class="nav_item_button button"><a href="https://github.com/nckprsn/scrollme"><span class="longtext">Download on </span>GitHub</a></li>
				</ul>
			</nav>
		...
		<div class="wrapper">
			...
			<div class="columns columns_content">
				...
				<div class="column column_large">
					...
					<p>Why just these properties? Because <a href="http://www.html5rocks.com/en/tutorials/speed/high-performance-animations/">browsers can animate them quickly</a>, keeping scrolling silky smooth.</p>
				...
				<div class="column column_large">
					...
					<ul>
						...
						<li>A framework for building sites like <a href="http://discover.store.sony.com/be-moved/">this</a> or <a href="http://www.flatvsrealism.com/">this</a>. ScrollMe is less complex than that; it's just for adding that little something extra.</li>
...
&lt;/<span class="code_tag">div</span>&gt;</code></pre>
			...
			<div class="columns columns_content">
				...
				<div class="column column_large">
					...
					<p>ScrollMe works fine with just about any up to date browser. It also works in IE10 but if you want support for IE9 you will need to use <a href="https://gist.github.com/paulirish/1579671">a polyfill for requestAnimationFrame</a>.</p>

					<h3>Having trouble?</h3>

					<p>If ScrollMe isn't doing what you expect it to please post an issue on <a href="https://github.com/nckprsn/scrollme/issues">GitHub</a>. You can also get my attention on Twitter: <a href="https://twitter.com/nickpearson">@nickpearson</a></p>
	...
	<footer class="footer scrollme">
		...
		>
			...
			<div class="wrapper">
				...
				<ul>
					<li><a href="http://www.pixilate.com/font/bellota/">Bellota</a> for the headings.</li>
					<li><a href="http://www.droidfonts.com/droidfonts/">Droid Serif &amp; Droid Mono</a> for the rest of the type.</li>
					<li><a href="http://fittextjs.com/">FitText.js</a> to make the big heading big.</li>
				</ul>

				<p>Made by <a href="http://nckprsn.com">Nick Pearson</a></p>
