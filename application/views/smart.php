...
<head>
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/css/custom.css') ?>">
	...
	<title>SMART | PT Len Rekaprima Semesta</title>
	...
	<header id="header" class="header-no-border-bottom" data-plugin-options="{'stickyEnabled': true, 'stickyEnableOnBoxed': true, 'stickyEnableOnMobile': true, 'stickyStartAt': 10, 'stickySetTop': '0px', 'stickyChangeLogo': false}">
      <div class="header-body">
        ...
        <div class="main" role="main">
                ...
                <section class="page-header page-header-custom-background" style="background-image:url(<?php echo base_url('assets/media/image/smart.jpg') ?>);height:250px;">
                        ...
                        <div class="col-md-12">
                            <div class="row">
                                <div class="col-md-12 col-lg-12">
                                    <h4 style="text-align: center;"><strong>Nilai Nilai Perusahaan (SMART)</strong></h4>
                                    <p style="text-align: justify;">Pertamina memiliki tata nilai sebagai komitmen perusahaan untuk mewujudkan visi dan misinya berdasarkan standar global dan penerapan tata kelola perusahaan yang baik (Good Corporate Governance). Nilai-nilai Pertamina disebut dengan 6C, terdiri dari Clean, Competitive, Confident, Customer Focus, Commercial dan Capable, dan nilai-nilai ini wajib diketahui dan menjadi pedoman bagi seluruh karyawan dalam beraktivitas. Pertamina menetapkan enam tata nilai perusahaan yang dapat menjadi pedoman bagi seluruh karyawan dalam menjalankan aktivitas sehari-hari. Penerapan tata nilai 6C didasarkan pada Surat Keputusan Direktur Utama PT Pertamina (Persero) No.Kpts-022/ COOOOO/2013-S0 Tentang Penerapan Tata Nilai 6C 01 Pertamina dan Anak Perusahaan (Operational Holding).</p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 col-lg-6">
                                    <p style="text-align: justify;"><strong>SUPPORT</strong><br>Dikelola secara profesional, menghindari benturan kepentingan, tidak menoleransi suap, menjunjung tinggi kepercayaan dan integritas. Berpedoman pada asasasas tata kelola korporasi yang baik.</p>
                                </div>
                                <div class="col-md-6 col-lg-6">
                                    <p style="text-align: justify;"><strong>MAINTAIN</strong> <br>Berperan dalam pembangunan ekonomi nasional, menjadi pelopor dalam reformasi Badan Usaha Milik Negara (BUMN), dan membangun kebanggaan bangsa. <br><strong></strong></p>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-4 col-lg-4">
                                    <p style="text-align: justify;"><strong>AGILE</strong><br>Menciptakan nilai tambah dengan orientasi komersial, mengambil keputusan berdasarkan prinsip-prinsip bisnis yang sehat.</p>
                                </div>
                                <div class="col-md-4 col-lg-4">
                                    <p style="text-align: justify;"><strong>RESPONSIBLE</strong><br>Mampu berkompetisi dalam skala regional maupun internasional, mendorong pertumbuhan investasi, membangun budaya sadar biaya dan menghargai kinerja.</p>
                                </div>
                                <div class="col-md-4 col-lg-4"> 
                                    <p style="text-align: justify;"><strong>TOTAL</strong> <br>Berorientasi pada kepentingan pelanggan dan berkomitmen untuk memberikan pelayanan terbaik kepada pelanggan. <br><strong></strong></p>
                                </div>
                            </div>
                        </div>
                    </div>
